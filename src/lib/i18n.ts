...
export const pricing = {
  id: {
    ...
    trialFree: "Coba 14 Hari Gratis",
    contactSales: "Berlangganan Sekarang",
    promoBanner: "🎉 Promo Terbatas — Hemat hingga 37% untuk 3 bulan pertama!",
    promoEnds: "Promo berlaku terbatas",
    discountBadge: "PROMO 3 BLN",
    ...
    features: [
      ["5 karyawan", "10 dokumen", "100 pertanyaan / bulan", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics dasar", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan", "Dedicated AI Capacity (BYOK)"],
      ["50 karyawan", "100 dokumen", "Pertanyaan tidak terbatas*", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics lengkap", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan", "Dedicated AI Capacity (BYOK)"],
      ["Karyawan tidak terbatas", "Dokumen tidak terbatas", "Pertanyaan tidak terbatas*", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics lengkap + ekspor", "Notifikasi email", "Slack & Teams integration", "Role per departemen", "Prioritas dukungan 24/7", "Dedicated AI Capacity (BYOK)"],
    ],
    fairUseNote: "* Fair use berlaku. Kapasitas dedicated tersedia dengan BYOK di paket Enterprise.",
    faqs: [
      ...
      { q: "Apakah ada batasan teknis dari infrastruktur AI?", a: "Platform kami berjalan di infrastruktur AI enterprise-grade. Untuk tim dengan volume pertanyaan sangat tinggi, paket Enterprise mendukung BYOK (Bring Your Own Key) — hubungkan API key Groq atau Gemini Anda sendiri untuk kapasitas dedicated tanpa batas, sesuai kuota akun API Anda." },
  ...
  en: {
    ...
    trialFree: "Try 14 Days Free",
    contactSales: "Subscribe Now",
    promoBanner: "🎉 Limited Promo — Save up to 37% for your first 3 months!",
    promoEnds: "Limited time offer",
    discountBadge: "3-MO PROMO",
    ...
    features: [
      ["5 employees", "10 documents", "100 questions / month", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Basic analytics", "Email notifications", "Slack integration", "Department roles", "Priority support", "Dedicated AI Capacity (BYOK)"],
      ["50 employees", "100 documents", "Unlimited questions*", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Full analytics", "Email notifications", "Slack integration", "Department roles", "Priority support", "Dedicated AI Capacity (BYOK)"],
      ["Unlimited employees", "Unlimited documents", "Unlimited questions*", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Full analytics + export", "Email notifications", "Slack & Teams integration", "Department roles", "24/7 Priority support", "Dedicated AI Capacity (BYOK)"],
    ],
    fairUseNote: "* Subject to fair use policy. Dedicated capacity available with BYOK on the Enterprise plan.",
    faqs: [
      ...
      { q: "Are there any technical limits from the AI infrastructure?", a: "Our platform runs on enterprise-grade AI infrastructure. For teams with very high question volumes, the Enterprise plan supports BYOK (Bring Your Own Key) — connect your own Groq or Gemini API key for dedicated capacity based on your own API account quota." },
