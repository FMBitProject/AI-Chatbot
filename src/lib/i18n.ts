...
export const pricing = {
  id: {
    ...
    features: [
      ["5 karyawan", "10 dokumen", "100 pertanyaan / bulan", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics dasar", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan"],
      ["50 karyawan", "100 dokumen", "Pertanyaan tidak terbatas", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics lengkap", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan"],
      ["Karyawan tidak terbatas", "Dokumen tidak terbatas", "Pertanyaan tidak terbatas", "Chat AI berbasis RAG", "Upload PDF, DOCX, Excel & PowerPoint", "Analytics lengkap + ekspor", "Notifikasi email", "Slack & Teams integration", "Role per departemen", "Prioritas dukungan 24/7"],
    ],
    faqs: [
  ...
  en: {
    ...
    features: [
      ["5 employees", "10 documents", "100 questions / month", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Basic analytics", "Email notifications", "Slack integration", "Department roles", "Priority support"],
      ["50 employees", "100 documents", "Unlimited questions", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Full analytics", "Email notifications", "Slack integration", "Department roles", "Priority support"],
      ["Unlimited employees", "Unlimited documents", "Unlimited questions", "RAG-based AI Chat", "PDF, DOCX, Excel & PowerPoint upload", "Full analytics + export", "Email notifications", "Slack & Teams integration", "Department roles", "24/7 Priority support"],
    ],
    faqs: [
