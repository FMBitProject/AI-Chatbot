...
export const admin = {
  id: {
    ...
    uploadDesc: "Upload SOP, regulasi HR, atau panduan IT dalam format PDF/DOCX.",
    ...
    dropzoneHint: "PDF, DOCX · Maks. 10 MB per file",
    ...
    formatNotSupportedDesc: "bukan file PDF atau DOCX.",
  },
  en: {
    ...
    uploadDesc: "Upload SOPs, HR regulations, or IT guidelines in PDF/DOCX format.",
    ...
    dropzoneHint: "PDF, DOCX · Max. 10 MB per file",
    ...
    formatNotSupportedDesc: "is not a PDF or DOCX file.",
  },
} as const;
...
export const pricing = {
  id: {
    ...
    features: [
      ["5 karyawan", "10 dokumen", "100 pertanyaan / bulan", "Chat AI berbasis RAG", "Upload PDF & DOCX", "Analytics dasar", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan"],
      ["50 karyawan", "100 dokumen", "Pertanyaan tidak terbatas", "Chat AI berbasis RAG", "Upload PDF & DOCX", "Analytics lengkap", "Notifikasi email", "Slack integration", "Role per departemen", "Prioritas dukungan"],
      ["Karyawan tidak terbatas", "Dokumen tidak terbatas", "Pertanyaan tidak terbatas", "Chat AI berbasis RAG", "Upload PDF & DOCX", "Analytics lengkap + ekspor", "Notifikasi email", "Slack & Teams integration", "Role per departemen", "Prioritas dukungan 24/7"],
    ],
    faqs: [
    ...
    featureGrid: [
      ...
      { title: "Multi-Format Dokumen", desc: "Upload PDF, DOCX dan ekstrak teks otomatis dengan AI" },
  ...
  en: {
    ...
    features: [
      ["5 employees", "10 documents", "100 questions / month", "RAG-based AI Chat", "PDF & DOCX upload", "Basic analytics", "Email notifications", "Slack integration", "Department roles", "Priority support"],
      ["50 employees", "100 documents", "Unlimited questions", "RAG-based AI Chat", "PDF & DOCX upload", "Full analytics", "Email notifications", "Slack integration", "Department roles", "Priority support"],
      ["Unlimited employees", "Unlimited documents", "Unlimited questions", "RAG-based AI Chat", "PDF & DOCX upload", "Full analytics + export", "Email notifications", "Slack & Teams integration", "Department roles", "24/7 Priority support"],
    ],
    faqs: [
      ...
      { q: "What document formats are supported?", a: "We currently support PDF and DOCX. Other formats (Excel, PowerPoint) are coming soon." },
    ...
    featureGrid: [
      ...
      { title: "Multi-Format Documents", desc: "Upload PDF, DOCX and auto-extract text with AI" },
