...
export const t = {
  ...
  en: {
    ...
    heroDesc: "Reach your SOPs, guides, notes and important documents instantly through AI, without opening files one by one.",
...
export const pricing = {
  id: {
    ...
    demoWhatsappMessage: "Halo, saya ingin menjadwalkan demo IntelliBase untuk paket {plan}.",
    ...
    featureGrid: [
      ...
      { title: "Impor dari Google Drive", desc: "Pilih file langsung dari Drive tim, tanpa unduh-upload manual" },
    ],
  },
  en: {
    ...
    demoWhatsappMessage: "Hi, I would like to schedule an IntelliBase demo for the {plan} plan.",
    ...
    featureGrid: [
      ...
      { title: "Google Drive Import", desc: "Pick files straight from your team's Drive, no download-then-upload" },
    ],
  },
} as const;
