      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
          {[
            ...
            { title: "4. Berbagi Data", body: "Kami berbagi data dengan pihak ketiga terbatas: OpenAI/Groq (pemrosesan AI, tanpa penyimpanan permanen), Google AI (embedding teks), Midtrans (pemrosesan pembayaran), Neon (penyimpanan database)." },
            { title: "5. Hak Anda", body: "Anda berhak: mengakses data Anda, mengoreksi data yang tidak akurat, menghapus akun dan seluruh data, mengekspor data Anda. Hubungi kami di privacy@intellibase.ai untuk permintaan tersebut." },
            ...
            { title: "9. Kontak", body: "Pertanyaan tentang privasi: privacy@intellibase.ai" },
          ].map((s) => (
            <div key={s.title}>
