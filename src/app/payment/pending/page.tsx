  ...
  return (
    <div className="min-h-[100dvh] bg-stone-50 flex flex-col items-center justify-center p-6">
      <div className="bg-white rounded-2xl border p-10 max-w-md w-full text-center shadow-sm">
        ...
        <h1 className="text-xl font-bold text-stone-900 mb-2">Menunggu Pembayaran</h1>
        ...
        <Link href="/admin">
          <Button className="w-full bg-teal-700 hover:bg-teal-800">Kembali ke Dashboard</Button>
        </Link>
      </div>
    </div>
  );
