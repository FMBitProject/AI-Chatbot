...
export async function PATCH(req: NextRequest) {
  ...
  if (company.plan !== "enterprise") {
    return NextResponse.json({ error: "BYOK hanya tersedia untuk paket Enterprise." }, { status: 403 });
  }
  ...
  // undefined = not provided (leave unchanged), null = explicit clear, string = new value
